...
@Entity
@Table(name="backup_subscriptions")
public class BackupSubscriptions {
	...
	public BackupSubscriptions() {
	}
	
	public BackupSubscriptions(String id, String name, BigDecimal price,
			BigDecimal security, Long numberBooks, Long delieveries,
